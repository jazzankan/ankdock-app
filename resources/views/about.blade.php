<x-app-layout>
    ...
    <div class="py-12 pl-2">
        <div class="max-w-screen-lg mx:auto sm:px-6 lg:px-8 bg-white py-4">
            <p class="px-2">Ankhemmet är en applikation gjord av Anders Fredriksson; en pensionerad biblioteksmedarbetare med
            ...
            <p class="mt-3 px-2">Ankhemmet är ett Laravel-projekt (PHP), stajlat med <a class="text-blue-600 hover:underline"
