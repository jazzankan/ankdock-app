    ...
    <div class="py-12 pl-2">
        <div class="max-w-screen-lg mx-auto sm:px-6 lg:px-8 bg-white py-4">
                <p>Ankhemmet är en applikation gjord av Anders Fredriksson; en pensionerad biblioteksmedarbetare med kvardröjande passion för programmering.
                    Det mesta är bakom inloggning och till för eget bruk, men det finns en öppen del i form av en <a class="text-blue-600 hover:underline" href='/blog'>blogg</a>.</p>
            <p class="mt-3">Ankhemmet är ett Laravel-projekt (PHP), stajlat med <a class="text-blue-600 hover:underline" href="https://tailwindcss.com/">Tailwind CSS</a>, och aningen kryddat med <a class="text-blue-600 hover:underline" href="https://github.com/alpinejs/alpine/">alpine.js</a></p>
